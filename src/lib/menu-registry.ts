...
export const MENU_REGISTRY: MenuRegistryItem[] = [
  ...
  { id: "referrals", defaultLabel: "Referrals", defaultIcon: "Sparkles", href: "/referrals", defaultGroup: "Billing", defaultOrder: 3 },
  ...
  { id: "admin-billing", defaultLabel: "Billing Controls", defaultIcon: "DollarSign", href: "/admin/billing", defaultGroup: "Administration", defaultOrder: 2, superAdminOnly: true },
  { id: "admin-payment-gateways", defaultLabel: "Payment Gateways", defaultIcon: "CreditCard", href: "/admin/payment-gateways", defaultGroup: "Administration", defaultOrder: 3, superAdminOnly: true },
  ...
  { id: "admin-cloudflare-images", defaultLabel: "Cloudflare Images", defaultIcon: "Cloud", href: "/admin/cloudflare-images", defaultGroup: "Administration", defaultOrder: 8, superAdminOnly: true },
  { id: "admin-ai-features", defaultLabel: "AI features", defaultIcon: "Sparkles", href: "/admin/ai-features", defaultGroup: "Administration", defaultOrder: 9, superAdminOnly: true },
  { id: "admin-ai-settings", defaultLabel: "AI providers", defaultIcon: "Brain", href: "/admin/ai-settings", defaultGroup: "Administration", defaultOrder: 10, superAdminOnly: true },
  { id: "admin-languages", defaultLabel: "Languages", defaultIcon: "Languages", href: "/admin/languages", defaultGroup: "Administration", defaultOrder: 11, permission: PERMISSIONS.USERS_VIEW },
...
export const SITE_MENU_REGISTRY: SiteMenuRegistryItem[] = [
  ...
  { id: "site-attributes", defaultLabel: "Attributes", defaultIcon: "SlidersHorizontal", path: "/attributes", defaultGroup: "Main", defaultOrder: 5 },
