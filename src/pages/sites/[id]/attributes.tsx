...
import { AttributesTab } from "@/components/explore/AttributesTab";
import { SyncLockBanner, useSyncLocked } from "@/components/site/SyncLockBanner";

function AttributesInner() {
  ...
  return (
    <div className="p-6 space-y-4 max-w-[1600px] mx-auto">
      ...
      <AttributesTab storeId={id} search={search} onSearchChange={setSearch} locked={locked} />
    </div>
  );
}

export default function SiteAttributesPage() {
  return (
    <SitePageShell>
      <AttributesInner />
    </SitePageShell>
